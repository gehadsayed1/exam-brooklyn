...
const withGraduationCap = (IconComponent) => {
  return h("svg", { width: 50, height: 50, viewBox: "0 0 24 24" }, [
    ...
    h(IconComponent, { class: "w-12 h-12 text-blue-800 dark:text-gray-200", x: 0, y: 5 }),
  ]);
};
    ...
    <div class="grid sm:grid-cols-2  grid-cols-1 p-5 sm:p-0  relative">
      ...
      <div>
        ...
        <div class="@container mr-10">
          <p class="text-gray-500 dark:text-gray-400 mt-2 text-lg font-medium">Please Select Your Role</p>

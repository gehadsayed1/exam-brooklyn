<template>
  <nav class="bg-[#EEEEEE] dark:bg-gray-700">
    <div class="max-w-screen-xl mx-auto px-4">
      ...
      <!-- User Info (Name + Icon) -->
      <div class="flex items-center gap-2 cursor-pointer p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600" @click="toggleDropdown">
      ...
      <div v-if="isDropdownOpen" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
        <div class="py-1">
          ...
          <router-link to="/profile" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600" @click="closeDropdown">
            Profile
          </router-link>
         
          <button class="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-600 flex gap-2 items-center" @click="handleLogout">

      ...
      <div v-if="showForm" class="fixed inset-0 bg-[rgba(0,0,0,0.6)] bg-opacity-30 flex items-center justify-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
          ...
          <div class="flex justify-end gap-3 mt-6">
            <button @click="toggleForm" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Cancel</button>
          ...
          <button @click="toggleForm" class="absolute top-2 right-2 text-gray-400 hover:text-gray-600 text-xl">×</button>
        </div>
      </div>
    </div>
  </template>
